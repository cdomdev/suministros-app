...
const Summary = () => {
    ...
    return (
        <div className="flex flex-col">
            <span className="my-3">Subtotal: <strong> $ {totalParseado}</strong> </span>
            <hr />
            <h2 className="my-2">Total a pagar ----- <strong> $ {totalParseado}</strong> </h2>
            <hr />
            <div className="flex items-center justify-center gap-2 my-2">
                <p className="text-sm  font-semibold ">El costo de envio aun  no esta incluido </p>
