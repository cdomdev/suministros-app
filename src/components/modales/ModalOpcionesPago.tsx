    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center">
                <button onClick={handleShow} className=" bg-blue-500 min-w-[33%] mx-auto flex items-center justify-center gap-1  py-2.5 px-4 rounded-md text-white duration-200 hover:bg-blue-600 ">
            ...
            <Modal
                ...
                <div className="font-font-cust-2 p-2">
                    <Modal.Body className="pt-0">
                        ...
                        <button className='mt-2 w-full bg-[#ebebeb] py-2 px-4 rounded-md hover:bg-[#d5d5d5] duration-100' onClick={() => setShow(false)}>
