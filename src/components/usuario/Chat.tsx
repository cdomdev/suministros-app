  ...
  return (
    <div className="border border-slate-50 bg-white p-3 rounded-md h-[600px] flex flex-col justify-between overflow-hidden bg-bg-chat bg-cover bg-no-repeat">
      <div
        ...
        {messages.length === 0 ? (
          <span className="text-center text-xs text-balance text-gray-500">
            Si tienes alguno duda sobre tus compras, envia un mensaje,
            trataremos de resolver tu inquietud lo mas pronto.
          </span>
        ) : (
